...
train_dataset = dataset.sample(frac=.80,random_state=0)
test_dataset = dataset.drop(train_dataset.index)

#Inspect the data
#sns.pairplot(train_dataset[["Eu1", "Eu2", "Eu3","AngD1","AngD2","AngD3","P","D","Time","Prop","Energy","Error"]], diag_kind="kde")
#plt.show()
...
def build_model():
  model = keras.Sequential([
    layers.Dense(130, activation=tf.nn.relu, input_shape=[len(train_dataset.keys())]),
...
early_stop = keras.callbacks.EarlyStopping(monitor='val_loss', patience=64)
